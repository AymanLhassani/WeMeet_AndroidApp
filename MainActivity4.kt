...
interface addSpace {
    ...
    fun add(@Query("n") numberPeople: String, @Query("schedule") schedule: String, @Query("location") location: String, @Query("ventilation") ventilation: String): Call<String>
}
...
class MainActivity4 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        addButton.setOnClickListener {
            ...
            add(numberPeople, schedule, location, ventilation)
        }
    }
    private fun add(numberPeople: String, schedule: String, location: String, ventilation: String) {
        ...
        api.add(numberPeople, schedule, location, ventilation).enqueue(object : Callback<String> {
