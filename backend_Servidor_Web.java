...
public class Application extends Controller
{
    ...
    public static void rentSpace(long id, int numberPeople, String scheduleAvailable, String location, String ventilation) {
        ...
        MEETING meeting1 = MEETING.find("byNumberpeoplemeetingAndSchedule", numberPeople, scheduleAvailable).first();

        if(meeting1 == null) {
            MEETING meeting2 = new MEETING(space.numberPeople, space.scheduleAvailable);
            meeting2.SpaceReserve = space;
            meeting2.UserReserve = c;
            meeting2.save();
